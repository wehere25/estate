  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // Circular floating action buttons in top right (like in the image)
      ...
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Property title with gradient text
                      ShaderMask(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (property.agentContact!.agency != null)
                                    Text(
                        ...
                        Material(
                          ...
                          child: InkWell(
                            onTap: () =>
                                _launchPhoneCall(property.agentContact!.phone),
                            borderRadius: BorderRadius.circular(borderRadius),
                            child: Ink(
                              width: double.infinity,
          ...
          Container(
            ...
            child: Text(
              '© 2023 RealState. All rights reserved.',
              style: TextStyle(
                color: textLightColor,
                fontSize: 12,
              ),
